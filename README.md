...
This bash script customizes your Termux terminal to have a "hacker terminal" look. It installs and configures Zsh with the Powerlevel10k theme, adds useful aliases, and sets a custom welcome message with ASCII ar
# Hacker Terminal Customization for Termux
...
This script is licensed under the [MIT License](LICENSE).
t. Additionally, it configures Neofetch to display system information on startup.
